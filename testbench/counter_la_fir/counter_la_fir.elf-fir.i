# 0 "fir.c"
# 1 "/home/ubuntu/123123/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "fir.c"
# 1 "fir.h" 1
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir(int method){
 ...
 ap = (*(volatile uint32_t*) 0x30000000);
 for (int i=0; i<64; i++) {
  while ((ap >> 4) & 1 != 1) {}
  ap = (*(volatile uint32_t*) 0x30000000);
 ...
 ap = (*(volatile uint32_t*) 0x30000000);
 (*(volatile uint32_t*)0x2600000c) = ((outputsignal[63] & 0xFF) << 24) | (0x5A << 16);
